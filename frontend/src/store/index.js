  ...
  mutations: {
    ...
    initializeStore(state) {
      ...
      if (localStorage.getItem("token")) {
        //token uzytkownika zapisany w localstorage gdy by wlaczyl przegladarke (dziala nawet gdy ktos ylaczy przegladarke czy kompa, maja date waznosci)
    ...
    setToken(state, token) {
      //! funcja przypisujaca token przy zalogowaniu
